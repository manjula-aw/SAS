...
ODS RTF FILE='/folders/myfolders/sasuser.v94/jatropha/negbinom-flowers.rtf';
...
proc glimmix data=jatropha.datacp1 method=LaPlace;
	...
	model NumOfFlowers=Fertilizer|Accession / dist=NegBin link=log;
